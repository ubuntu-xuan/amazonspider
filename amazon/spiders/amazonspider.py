...
class AmazomSpider_reviews(CrawlSpider):
    ...
    # print(sys.argv[1])
    #
    good_name = sys.argv[1].split('/')[3]
    good_num = sys.argv[1].split('/')[5]

    start_urls = ["https://www.amazon.com/%s/product-reviews/%s/ref=cm_cr_arp_d_show_all?ie=UTF8&reviewerType=all_reviews&pageNumber=1"%(good_name,good_num)]
