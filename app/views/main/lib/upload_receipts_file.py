...
class upload_receipts_file():
    def __init__(self, name, type=None, size=None,upload_date=None, not_allowed_msg=''):
        ...
        self.url = "data/receipts/%s" % name
        #self.thumbnail_url = "thumbnail/%s" % name  获取每张缩略图
        self.thumbnail_url = "data/receipts/receipts_thumbnail/Picture_icon.png" 
        self.iconurl = "data/receipts/receipts_thumbnail/PDF_ICON.png"
